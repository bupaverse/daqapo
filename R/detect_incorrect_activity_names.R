...
#' @export
#'
detect_incorrect_activity_names <- function(activitylog, details, filter_condition) {
  UseMethod("detect_incorrect_activity_names")

}
#' @export
detect_incorrect_activity_names.activitylog <- function(activitylog, details = TRUE, filter_condition = NULL){
