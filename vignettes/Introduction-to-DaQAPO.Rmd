...
| detect_overlaps | Checks if a resource has performed 2 activities in parallel | Data frame containing the activities, the number of overlaps and average overlap in minutes |
| detect_related_activities | Function detecting missing related activities, i.e. activities that should be registered because another activity is registered for a case | Summary in console + Returns cases violating relating activities |
